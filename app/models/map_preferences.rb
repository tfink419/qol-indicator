class MapPreferences < ApplicationRecord
  ...
  validates :grocery_store_quality_transit_type, :presence => true, :inclusion => 1..GroceryStore::NUM_TRANSIT_TYPES
  ...
  validates :grocery_store_quality_ratio, :presence => true, :inclusion => 0..100
  validates :census_tract_poverty_ratio, :presence => true, :inclusion => 0..100


  def public_attributes 
    {
      :grocery_store_quality_transit_type => grocery_store_quality_transit_type,
      :census_tract_poverty_low => census_tract_poverty_low,
      :census_tract_poverty_high => census_tract_poverty_high,
      :grocery_store_quality_ratio => grocery_store_quality_ratio,
